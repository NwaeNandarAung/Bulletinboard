        ...
        @method('PUT')
          <table class='table table-borderless'>
            ...
            <tr>
              <td>Status</td>
              @foreach ($postData as $post)
              <td><input data-id="1" class="toggle-class" type="checkbox" style="padding-top:0px; data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $post->status ? 'checked' : '' }} disabled>
              </td>   
              @endforeach
            </tr>
          </table>
